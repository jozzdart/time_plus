...
class DurationFrom {
  ...
  static Duration weeks(int weeks) {
    return Duration(days: weeks * TimePlusDurationConsts.daysInWeek);
  }
  ...
  static Duration months(int months) {
    return Duration(days: months * TimePlusDurationConsts.daysInMonth);
  }
  ...
  static Duration years(int years) {
    return Duration(days: years * TimePlusDurationConsts.daysInYear);
  }
  ...
  static Duration decades(int decades) {
    return Duration(days: decades * TimePlusDurationConsts.daysInDecade);
  }
  ...
  static Duration centuries(int centuries) {
    return Duration(days: centuries * TimePlusDurationConsts.daysInCentury);
  }
  ...
  static const Duration year =
      Duration(days: TimePlusDurationConsts.daysInYear);
  ...
  static const Duration week =
      Duration(days: TimePlusDurationConsts.daysInWeek);
